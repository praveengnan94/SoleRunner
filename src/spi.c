...
//	//bma280_write_byte(0x7E, 0xb6);	// CMD reg - 0x7E.  Soft reset occurs when 0xB6 is written to this register
	...
	//	//sleepDelay(2000);
		...
		temp_byte1 = bma280_read_byte(0x03);	/* PMU_STATUS read - changed to 0x10*/
	//	//sleepDelay(2000);
	...
	//	//sleepDelay(2000);
	//	temp_byte1 = bma280_read_byte(0x78);	/* STEP_CNT_0 read - def value is 0x00 */
	//	sleepDelay(2000);
